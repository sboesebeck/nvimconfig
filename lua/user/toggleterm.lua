...
function _G.set_terminal_keymaps()
	...
	vim.api.nvim_buf_set_keymap(0, "t", "<C-j>", "<cmd>:wincmd h<cr>", opts)
	vim.api.nvim_buf_set_keymap(0, "t", "<C-k>", "<cmd>:wincmd j<cr>", opts)
	vim.api.nvim_buf_set_keymap(0, "t", "<C-i>", "<cmd>:wincmd k<CR>", opts)
